...
const Home = () => {
  ...
  const handleNavigationCreatePosts = () => {
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <button onClick={handleClick}> Mostra título / Esconde título </button>
        <button onClick={handleNavigationPosts}> Posts </button>
        <button onClick={handleNavigationCreatePosts}> Create Post </button>
